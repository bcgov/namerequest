        ...
        <v-col cols="10" class="pa-0">
          ...
          <v-row class="mt-n1">
            <v-col cols="12" class="py-0 my-0">
              ...
              >
                <!-- Using activator slot exclusivey to avoid having to absoluetly position v-menu.  Visibility
                is controlled by "showAddressMenu" getter, "on" function provided by slot is not used-->
                ...
                <v-list class="ma-0 pa-0" style="border-radius: 0">
                  ...
                  <!--
                  <v-list-item dense class="text-right">
                    <a href="#" @click="disableSuggestions = true">disable</a> Address Suggestions
                  </v-list-item>
                  -->
                  <v-list-item
