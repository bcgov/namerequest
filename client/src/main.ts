...
function setVueEnvironment (config: EnvConfigI): void {
  ...
  Vue.prototype.$DEV_NR_COMPLETION_TIMEOUT_MS = config.$DEV_NR_COMPLETION_TIMEOUT_MS
  ...
  Vue.prototype.$DEV_EXISTING_NR_TIMEOUT_MS = config.$DEV_EXISTING_NR_TIMEOUT_MS
  ...
  Vue.prototype.$DEV_PAYMENT_COMPLETION_TIMEOUT_MS = config.$DEV_PAYMENT_COMPLETION_TIMEOUT_MS
}
