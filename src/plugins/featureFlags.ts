...
const defaultFlagSet: LDFlagSet = {
  ...
  'advanced-search-enabled': false, // by default don't show advanced search // FUTURE: remove when feature is ready
  'staff-payment-enabled': false // by default don't show staff payment // FUTURE: remove when feature is ready
}
