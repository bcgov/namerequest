...
export const TOGGLE_CANCEL_MODAL = 'toggleCancelModal'
export const CANCEL_MODAL_IS_VISIBLE = 'cancelModalIsVisible'
...
export const GET_SBC_PAYMENT = 'getSbcPayment'
...
export const GET_SBC_PAYMENT_STATUS = 'getSbcPaymentStatus'
export const GET_PAYMENT_DATE = 'getPaymentDate'
...
export const SET_SBC_PAYMENT = 'setSbcPayment'
